...
Below is a written guide on how to register an account on our website, migrate your in-game nickname to your new account and generate a login code to use in-game. 

If you prefer a video guide, you can watch this video instead:

...
If you do not remember your login code, please [follow the steps below](/information/faq/#49-i-cannot-login-on-kog-servers-i-forgot-my-login-code) to generate a new login code.
...
You may use other clients as long as they do not contain any functionality that would give you an unfair advantage over other players. This includes any functionality that allows:
...
Some popular clients that are allowed include:

- Vanilla Teeworlds client
- DDNet client
- T-Client
...
<Aside type="danger">
If you use any of the following clients to connect to KoG servers, you will be banned on sight:

- KRX Client
- Other clients which include functionality that is not allowed
</Aside>
...
To make a report, please follow the instructions above.
...
Please refer to the [roles](/information/roles/) page to learn more about the requirements and how to apply for each role.
...
- You can [apply to become a tester](/information/faq/#38-how-can-i-become-a-tester) and help us test new maps, if you meet the requirements
- You can [apply to become a moderator](/information/faq/#37-how-can-i-become-a-moderator) and help us keep the servers clean and fun for everyone
- You can [apply to become a developer](/information/faq/#39-how-can-i-become-a-developer) and help us develop new projects and improve existing ones
...
If you cannot remember your password, please refer to [4.10 I cannot login on the website, I don’t remember my email or password](/information/faq/#410-i-cannot-login-on-the-website-i-dont-remember-my-email-or-password) to reset your password.
...
### 4.5 I cannot proceed with the migration, it says: "Verify your KoG One Account"
...
### 4.6 I cannot proceed with the migration, I did not receive an email to verify my account
...
### 4.7 I cannot login on KoG servers, it says: "Your login request is now being processed."
...
### 4.8 I cannot login on KoG servers, it says: "User does not exist"

Please generate a new login code using [the instructions below](/information/faq/#49-i-cannot-login-on-kog-servers-i-forgot-my-login-code). Note that it can take up to 30 minutes until the new login code works in-game. Please be patient and try again later if it does not work immediately.

### 4.9 I cannot login on KoG servers, I forgot my login code
...
### 4.10 I cannot login on the website, I don't remember my email or password
...
### 4.11 I cannot see any "[A]" servers in the server list

...
<Aside type="caution">The Random Map Event System will be enabled in the upcoming days!</Aside>
...
<Aside type="caution">All players will experience a reset concerning the use of `/power`. Until the reset occurs, users who have previously collected it can continue to use it.</Aside>
...
### <Badge text="Change" variant="tip" /> Map Rerating

Can be found [here](/blog/2024-11-22-map-rerating)

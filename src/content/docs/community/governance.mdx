...
import organizationalChart from '../../../assets/mermaid/organizational-chart.svg'
...
<Image src={organizationalChart} alt="organizational chart" />
...
[Code of Conduct](/info/code-of-conduct) violations by community members will be discussed and resolved by the Code of Conduct Enforcement Committee, which is appointed by the Governing Board.
